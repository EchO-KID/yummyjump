...
-- LZU - pix2d. Change package loading (not working with cocos2dx)
...
local plural      = require 'lib/i18n/plural'
local interpolate = require 'lib/i18n/interpolate'
local variants    = require 'lib/i18n/variants'
local version     = require 'lib/i18n/version'
...
function i18n.loadFile(path)
    ...
    -- local data = chunk()
    -- i18n.load(data)
    i18n.load(assert(loadstring(util.readDataFile(path)))())
end

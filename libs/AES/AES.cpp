...
/// LZU http://www.dreamincode.net/forums/topic/187905-rotl-and-rotr-what-are-the-header-files/
#define ROTATE_LEFT(x, n) (((x) << (n)) | ((x) >> (32-(n))))
#define ROTATE_RIGHT(x, n) (((x) >> (n)) | ((32-(n))) << (x))
#define RotByte(a) ROTATE_RIGHT(a, 8)
#define RotByteL(a) ROTATE_LEFT(a, 8)
